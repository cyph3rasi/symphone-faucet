  ...
  return (
    <div className="lg:col-span-3 order-2 lg:order-3">
      <div className="bg-black/30 backdrop-filter backdrop-blur-lg p-6 rounded-3xl border border-green-500/20 h-full">
        <h2 className="text-xl font-bold mb-4 font-zen-dots text-green-300">View Tokens in MetaMask</h2>
        <div className="space-y-4 text-sm text-gray-300">
          <p>To view your FREEPEPE tokens in MetaMask after claiming, follow these steps:</p>
          ...
          <div className="space-y-3" key={`token-setup-${Date.now()}`}>
            ...
            <p>5. Copy and paste the FREEPEPE Token contract address:</p>
            <p className="font-mono text-xs break-all bg-black/40 p-2 rounded-lg select-all">
              {TOKEN_ADDRESS}
            </p>
            <p>6. The token symbol (PEPE) and decimals (18) should auto-populate</p>
            <p>7. Click "Add Custom Token" to proceed</p>
            <p>8. Review the token details and click "Import Tokens" to confirm</p>
            <p>9. You should now see your FREEPEPE token balance in your MetaMask wallet</p>
            <p className="text-green-300">Note: You only need to add the custom token once. After importing, MetaMask will automatically track your PEPE balance.</p>
          </div>
        </div>
      </div>
    </div>
