  ...
  <div className="space-y-6">
    ...
    <div className="bg-black/30 backdrop-filter backdrop-blur-lg p-6 rounded-3xl border border-green-500/20">
      ...
      <div className="space-y-3 text-gray-300 font-unbounded text-sm">
        ...
        <p>4. Click 'Claim Tokens' to receive your Free PEPE tokens</p>
    ...
    {/* Video Section */}
    <div className="bg-black/30 backdrop-filter backdrop-blur-lg p-6 rounded-3xl border border-green-500/20">
      <h2 className="text-2xl font-unbounded font-medium mb-4 text-green-300 tracking-tight">Tutorial Video</h2>
      <div className="overflow-hidden rounded-xl shadow-xl bg-black/40">
        <div className="relative w-full pt-[56.25%]">
          <iframe
            src="https://www.youtube.com/embed/8TwyfnpmyVI"
            title="Free PEPE Token Tutorial"
